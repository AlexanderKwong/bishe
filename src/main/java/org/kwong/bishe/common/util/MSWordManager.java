...
public class MSWordManager { 
        ...
        /** *//** 
         * 把当前插入点以后选定选定内容设定为替换文本 
         *     
         * @param toFindText 查找字符串 
         * @param newText 要替换的内容 
         * @return 
         */ 
        public boolean replaceAfterText(String toFindText, String newText) { 
                if (!find(toFindText)) 
                        return false; 
                Dispatch.put(selection, "Text", newText); 
                return true; 
         ...
         * @param newText 要替换的内容 
         */ 
        public void replaceAllAfterText(String toFindText, String newText) { 
                while (find(toFindText)) { 
                        Dispatch.put(selection, "Text", newText); 
                        Dispatch.call(selection, "MoveRight"); 
                } 
       ...
       public void createTable(String pos, int numCols, int numRows) {  
        ...
        public void addTableCol(int tableIndex, int colIndex) { 
                ...
                // 表格的所有行 
                Dispatch cols = Dispatch.get(table, "Columns").toDispatch(); 
                LoggerUtil.logger.info(Dispatch.get(cols, "Count")); 
        ...
        public static void main(String args[])throws Exception { 
        	/** demo1
                ...
                msWordManager.insertImage("http://localhost/images_else/image022.png");
                msWordManager.insertText("aaaaaaaaaaaaaaaaaaaaa"); 
                msWordManager.insertImage("http://localhost/images_else/image020.png");
