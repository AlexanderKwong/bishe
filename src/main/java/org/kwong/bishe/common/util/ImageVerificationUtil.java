...
public class ImageVerificationUtil {
	...
	// 用工厂方法创建对象
	protected ImageVerificationUtil(int charCount) {
	 ...
	 *             参数charCount错误时抛出
	 */
	public static ImageVerificationUtil createInstance(int charCount)
			throws Exception {
		if (charCount < 1 || charCount > MAX_CHARCOUNT) {
			throw new Exception(
					"Invalid parameter charCount,charCount should between in 1 and 16");
		}
		return new ImageVerificationUtil(charCount);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		LoggerUtil.info(ImageVerificationUtil.createInstance(4).drawAlpha(
				ImageVerificationUtil.GRAPHIC_PNG,
				new FileOutputStream("e:/myimg.png")));
